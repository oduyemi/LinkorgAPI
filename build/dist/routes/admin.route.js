...
router.put("/:adminId", auth_middleware_1.authenticateAdmin, admin_controller_1.updateAdmin);
router.delete("/:adminId", auth_middleware_1.authenticateAdmin, admin_controller_1.deleteAdmin);
router.put("/:adminId/reset-password", auth_middleware_1.authenticateAdmin, admin_controller_1.resetPassword);
